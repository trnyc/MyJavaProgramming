...
public class Student {
 ...
 /*   public Student(String name, int age, char gender, char grade, String schoolName) {
    ...
    This is default constructor created by intelli j via shortcut. But we must change it
    since we are using 'private' instances. We must use 'setter' instead of 'this.' method.
  */
