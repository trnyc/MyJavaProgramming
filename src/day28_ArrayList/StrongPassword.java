...
public class StrongPassword {
    public static void main(String[] args) {
        ...
        boolean r2 = false;// is contain upper case
        boolean r3 = false;// is contain lower case
        boolean r4 = false;// is contain special character
        boolean r5 = false;// is contain digit
