...
//As long as condition is false, only do while loof will execute the statement
//Because do while loop firs executes the statement and then checks the condition
