...
public class C06_UniqueElements {
    public static void main(String[] args) {
        ...
        System.out.println("---- second solution without loop-------------");

        ArrayList<Integer> list2 = new ArrayList<>();
        list2.addAll(Arrays.asList(1,1,2,3,3,4,5,5,6,7,7,8,9,9));

        ArrayList<Integer> unique2 = new ArrayList<>(list2); // we passed all the elements from list2 to unique2
