...
public class SetPractice2 {
    public static void main(String[] args) {
        ...
        System.out.println(set1);// HashSet removes the duplicates but does not keep the order
                                // [Paper towels, Wooden Spoon, Coke, Eggs, Book, Phone, Pen, Milk]

        arr = set1.toArray(new String[0]);// You can convert it back to Array then toString
        ...
        for (String each : new LinkedHashSet<>(Arrays.asList(str.split("")))) {
                                                        //.split() to convert str to Array
                                                    //Arrays.asList() to convert Array to Collection type
