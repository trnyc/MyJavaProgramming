...
//it automatically recognizes which method need to use depending on data type and number of parameters
...
/* As long as it has different data taypes or different number of parameters, you can give same name
to all your methods that have smiler usage.
 */
