...
public class ScrumTeam {
    ...
    public void addTester(Tester tester){
        testersList.add(tester);// to add single tester to the team
    }

    public void addTesters(Tester[] testers){// to add multiple testers using Array
        testersList.addAll( Arrays.asList(testers) );
    }

    public void addDeveloper(Developer developer){
        devopsList.add(developer);// to add single developer
    }

    public void addDevelopers(Developer[] developers){
        devopsList.addAll(Arrays.asList(developers)); // to add multiple developer using Array
    }
