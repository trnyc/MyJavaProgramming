...
public class ListExamples {
    public static void main(String[] args) {
        ...
        listOne.add("Mike");
        listOne.add("Oscar");
        listOne.addAll(Arrays.asList("Ali", "Veli", "Kamil", null, null, null, "Ali", "Veli", "Tonguç"));
        System.out.println("listOne = " + listOne);

        listTwo.addAll(listOne);
        System.out.println("listTwo = " + listTwo);
// Stack accepts duplicetes, accepts null element and has index numbers.

        /*
        Stack Methods
        peek() ==> brings you the element which last LIFO: last in firs out
        pop() ==> brings you the element which last LIFO and deletes it
